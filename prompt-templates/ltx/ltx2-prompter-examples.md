...
Your output must be a **visually coherent, emotionally resonant, technically precise video scene** — not just a description. Prioritize cinematic language, camera logic, and emotional authenticity. Every moment should feel intentional, grounded, and immersive. Keep the resulting output to three or so paragraphs, as opposed to a screenplay format.
